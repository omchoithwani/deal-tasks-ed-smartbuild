...
export function buildText(taskRecords, weekLabel) {
  ...
  taskRecords.forEach((record, i) => {
    ...
    lines.push(`Contact:            ${deal.contactName ?? 'N/A'}`);
    lines.push(`Company:            ${deal.companyName ?? 'N/A'}`);
      ...
      <div style="margin-bottom:32px;padding:20px;border:1px solid #e0e0e0;border-radius:8px;font-family:sans-serif;">
        ...
        <table style="border-collapse:collapse;width:100%;font-size:14px;color:#444;">
          ...
          <tr style="background:#fafafa;">
            <td style="padding:6px 12px 6px 0;font-weight:600;white-space:nowrap;vertical-align:top;">Contact</td>
            <td style="padding:6px 0;">${deal.contactName ?? 'N/A'}</td>
          </tr>
          <tr>
            <td style="padding:6px 12px 6px 0;font-weight:600;white-space:nowrap;vertical-align:top;">Company</td>
            <td style="padding:6px 0;">${deal.companyName ?? 'N/A'}</td>
          </tr>
          <tr style="background:#fafafa;">
